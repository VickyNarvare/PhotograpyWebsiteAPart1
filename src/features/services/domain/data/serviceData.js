...
export const services = [
  {
    ...
    points: ["Full-day & multi-day coverage", "Two photographers on request", "Candid-first, directed-light approach", "Curated highlight films"],
  },
  {
    id: 2,
    number: "02",
    ...
    points: ["Individual & family sessions", "Natural-light locations", "Studio options in Indore", "Print-ready, gallery-graded edits"],
  },
  {
    id: 3,
    number: "03",
    ...
    points: ["Lookbooks & campaigns", "Moodboards & art direction", "Studio & location sets", "Retouching & colour grading"],
  },
  {
    id: 4,
    number: "04",
    ...
    points: ["Architecture & interiors", "Product & F&B", "Brand portrait banks", "Licensed usage rights"],
  },
  {
    id: 5,
    number: "05",
    ...
    points: ["Location scouting & styling help", "Golden-hour sessions", "Story-driven direction", "Same-gallery delivery with the wedding"],
  },
  {
    id: 6,
    number: "06",
    ...
    points: ["Launches & festivals", "Private celebrations", "Documentary-style coverage", "48-hour preview gallery"],
  },
];
